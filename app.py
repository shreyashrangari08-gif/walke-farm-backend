...
def login():
    ...
    # Verify Password (Supports both hashed and direct match backup)
...
# Admin: Update Plot Availability Status
...
def export_csv():
    ...
    return Response(
        csv_data,
        mimetype="text/csv",
        headers={"Content-Disposition": "attachment;filename=Walke_Farm_Bookings.csv"}
    )
